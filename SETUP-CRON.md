...
**`https://scale-ag.github.io/dashboard-elisa-lobo/`**
...
- Repository access: **Only select repositories → `dashboard-elisa-lobo`**
...
### URL
```
https://api.github.com/repos/scale-ag/dashboard-elisa-lobo/actions/workflows/deploy.yml/dispatches
```
